    ...
    <div style={{ minHeight: "100vh", background: "var(--bg)" }}>
      ...
      <section className="hero-section" style={{ padding: "80px 24px 72px", textAlign: "center", maxWidth: 820, margin: "0 auto" }}>
        ...
        <h1 style={{
          ...
          <span style={{ color: "var(--accent)" }}>Le beat du producteur.</span><br />
        ...
        <div className="hero-btns" style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
          ...
          <button style={{
            ...
            border: "1px solid var(--border-2)", borderRadius: 28, padding: "14px 34px",
        ...
        <div style={{
          ...
          {[
            ...
            <div key={l} style={{ textAlign: "center" }}>
              <div style={{ fontSize: 26, fontWeight: 900, color: "var(--accent)" }}>{n}</div>
              <div style={{ fontSize: 12, color: "var(--text-4)", marginTop: 4 }}>{l}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          <h2 style={{ fontSize: 22, fontWeight: 900, textAlign: "center", marginBottom: 8, color: "var(--text)" }}>
            Comment ça marche ?
          </h2>
          <p style={{ color: "var(--text-4)", textAlign: "center", marginBottom: 48, fontSize: 14 }}>
          ...
          <div className="steps-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 16 }}>
            {[
              ...
              <div key={step.n} style={{
                ...
                <div style={{ fontSize: 10, color: "var(--accent)", fontWeight: 700, letterSpacing: "0.1em", marginBottom: 6 }}>
                  ÉTAPE {step.n}
                </div>
                <div style={{ fontSize: 15, fontWeight: 700, marginBottom: 8, color: "var(--text)" }}>{step.title}</div>
      ...
      <section style={{
        ...
        <h2 style={{ fontSize: 28, fontWeight: 900, marginBottom: 12, color: "var(--text)" }}>
          Prêt à créer ?
        </h2>
